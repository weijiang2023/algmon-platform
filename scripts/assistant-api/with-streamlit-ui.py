...
assistant_id = 'asst_tss7mtsaBsxdERQGHCUHW2UI'
...
website_url = st.sidebar.text_input(
    "Enter a website URL to scrape and organize into a PDF", key="website_url")
...
if st.sidebar.button("Start Chat"):
    ...
    if st.session_state.file_id_list:
        ...
        st.sidebar.warning(
            "Please upload at least one file to start the chat.")
...
st.title("基于 Assistants API 的智能聊天")
st.write("算法妈妈内部开发工具。")
